...
| File | Purpose |
| --- | --- |
| `kernel.pyrel` | Pyrel source implementation |
| `kernel.pyrel.c` | C emitted by Pyrel |
...
> **For this kernel, Pyrel produces correct C with runtime performance close to hand-written C, while its generated source remains larger because of the automatic runtime and allocation tracking.**
...
The comparison is best interpreted as a code-generation and runtime fixture. It demonstrates that Pyrel's generated C can be independently inspected, compiled, and compared with other C-emitting toolchains. It should not be used to claim that Pyrel, Nim, or Cython has a universal performance advantage.
