...
> **For this kernel, Basalt produces correct C with runtime performance close to hand-written C, while its generated source remains larger because of the automatic runtime and allocation tracking.**
...
The comparison is best interpreted as a code-generation and runtime fixture. It demonstrates that Basalt's generated C can be independently inspected, compiled, and compared with other C-emitting toolchains. It should not be used to claim that Basalt, Nim, or Cython has a universal performance advantage.
