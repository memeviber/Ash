#!/usr/bin/env python3
"""Rename Basalt source files from the legacy extension to .basalt.
...
TEXT_SUFFIXES = {
    ".basalt", ".c", ".h", ".ml", ".mli", ".md", ".sh", ".py", ".json",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Rename Basalt source files to .basalt")
